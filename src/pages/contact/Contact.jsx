            ...
            <Container maxWidth="lg">
                ...
                <Box sx={{ textAlign: "center", mb: 6 }}>
                    <Box component="span" sx={{
                        display: "inline-block", px: 2.5, py: 0.75, borderRadius: 999,
                        bgcolor: "#f3e8ff", color: "#a21caf", fontWeight: 600, fontSize: 13, mb: 2
                    }}>
                        {t("Contact Us")}
                    </Box>
                    <Typography variant="h2" fontWeight={800} sx={{ fontSize: { xs: "2rem", md: "2.8rem" }, mb: 1.5 }}>
                        {t("How can we help you?")}
                    </Typography>
                    <Typography color="text.secondary" sx={{ maxWidth: 480, mx: "auto", lineHeight: 1.8 }}>
                        {t("contact_hero_desc")}
                    </Typography>
                </Box>
                    ...
                    <Grid item size={{ xs: 12, md: 6 }}>
                        <Paper elevation={0} sx={{ p: 3, borderRadius: 4, border: "0.5px solid", borderColor: "divider" }}>
                            ...
                            <Button fullWidth variant="contained" size="large"
                                sx={{ borderRadius: 2.5, py: 1.5, bgcolor: "#c026d3", "&:hover": { bgcolor: "#a21caf" }, fontWeight: 700 }}>
                                {t("Send Message")}
                            </Button>
                        </Paper>
                    </Grid>
                    ...
                    <Grid item size={{ xs: 12, md: 6 }}>
                        <Box sx={{ display: "flex", flexDirection: "column", gap: 1.5 }}>
                            {contactInfo.map((item) => (
                                <Paper key={item.labelKey} elevation={0} sx={{
                                    p: 2, borderRadius: 3, border: "0.5px solid", borderColor: "divider",
                                    display: "flex", alignItems: "center", gap: 2
                                }}>
                                    <Box sx={{
                                        width: 44, height: 44, borderRadius: 3,
                                        bgcolor: "#f3e8ff", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0
                                    }}>
                                        {item.icon}
                                    </Box>
                                    <Box>
                            ...
                            <Paper elevation={0} sx={{
                                height: 200, borderRadius: 3, border: "0.5px solid",
                                ...
                                >
                                    ...
                                    />
                                    <Marker position={[32.2211, 35.2544]}>
                                        <Popup>KaShop — Nablus</Popup>
                                    </Marker>
                                </MapContainer>
                            </Paper>
                        </Box>
                ...
                <Box sx={{ mt: 6 }}>
                    <Box sx={{ textAlign: "center", mb: 4 }}>
                        ...
                        <Typography fontWeight={800} fontSize={{ xs: "1.5rem", md: "2rem" }}>
                        ...
                        {faqs.map((faq, i) => (
                            ...
                            >
                                ...
                                <AccordionDetails sx={{ px: 3, py: 2, borderTop: "0.5px solid", borderColor: "divider" }}>
                                    <Typography fontSize={14} color="text.secondary" lineHeight={1.8}>
                                        {t(faq.aKey)}
                                    </Typography>
                                </AccordionDetails>
                            </Accordion>
