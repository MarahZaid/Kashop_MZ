                                ...
                                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                                    ...
                                    {activeFiltersCount > 0 && (
                                        <Chip
                                            ...
                                            size="small"
                                            sx={{ bgcolor: "#c026d3", color: "white", height: 20, fontSize: 11 }}
                                        />
                                    )}
                                </Box>
                                {activeFiltersCount > 0 && (
                                ...
                                <Collapse in={openCategories}>
                                    <List dense disablePadding sx={{ px: 1, pb: 1.5 }}>
                                        ...
                                        {categories.map((cat) => (
                                            <ListItemButton
                                                key={cat.id || cat}
                                                selected={selectedCategory === (cat.id || cat)}
                                ...
                                <Collapse in={openPrice}>
                                    <Box sx={{ px: 2.5, pb: 2.5 }}>
                                        <Slider
                                            ...
                                            sx={{
                                                color: "#c026d3",
                                                "& .MuiSlider-thumb": { "&:hover": { boxShadow: "0 0 0 8px rgba(192,38,211,0.15)" } }
                                            }}
                                        />
                                ...
                                <Pagination
                                    ...
                                    sx={{
                                        "& .MuiPaginationItem-root": {
                                            "&.Mui-selected": { bgcolor: "#c026d3", color: "white" },
